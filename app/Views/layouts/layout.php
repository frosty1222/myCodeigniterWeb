               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('index_category') ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Category View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('index_product') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Product View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('user_view') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>User View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('order_view') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Order View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('orderdetail_view') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Order Detail View</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('contact_view') ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Contact View</p>
                                    </a>
                                </li>
